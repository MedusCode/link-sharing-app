...
import { ReactComponent as IconUploadImage } from './icons/icon-upload-image.svg';
...
export const ImageInput = forwardRef<ImageInputHandle, ImageInputProps>(function ImageInput(
  {
    id,
    value,
    onChange,
